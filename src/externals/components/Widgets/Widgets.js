...
import '../Calendar/core_main.css';
import '../Calendar/daygrid_main.css';
import '../Calendar/timegrid_main.css';
    ...
    constructor() {
        ...
        this.state = {
            ...
            calendarEvents: [
              {
                title: "Wordcamps",
                start: new Date("2019-09-17 00:00"),
                id: "99999998"
              },
              {
                title: "Apple Event",
                start: new Date("2019-09-26 00:00"),
                id: "99999999"
              }
            ],
            widths: 150
