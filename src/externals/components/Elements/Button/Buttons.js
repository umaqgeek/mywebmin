                    ...
                    <Col md={6}>
                        <Card className="card-statistics mb-30">
                            <CardBody>
                                ...
                                <Row>
                                    <Col md={12}>
                                        <Button className="button" size="xsmall" >x small</Button>
                                        <Button className="button" size="small">small</Button>
                                        <Button className="button" >default</Button>
                                        <Button className="button" size="medium" >medium</Button>
                                        <Button className="button" size="large" >large</Button>
                                    </Col>
                                </Row>
                            </CardBody>
                        </Card>
                        <Card className="card-statistics mb-30">
                            <CardBody>
                                ...
                                <Row>
                                    <Col md={12}>
                                        <Button className="button black" size="xsmall">x small</Button>
                                        <Button className="button black" size="small" >small</Button>
                                        <Button className="button black" >default</Button>
                                        <Button className="button black" size="medium" >medium</Button>
                                        <Button className="button black" size="large" >large button</Button>
                                    </Col>
                                </Row>
                        ...
                        <Card className="card-statistics mb-30">
                            <CardBody>
                                ...
                                <button className="button big-button mb-20">
                                    Webmin big button<br /><span> Lorem ipsum dolor sit.</span>
                                </button>
